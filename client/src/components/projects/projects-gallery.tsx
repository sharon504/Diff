...
const ProjectCard = ({ project }: { project: T_project }) => {
  ...
  return (
    <div className="h-96 p-3 flex flex-col justify-between gap-4 bg-white rounded-lg shadow-md overflow-hidden hover:scale-[1.02] ease-in-out duration-500">
...
const ProjectsGallery = () => {
  ...
  return (
    <ul className="grid gap-8 md:grid-cols-3">
      {$processedProjects.map((project: T_project) => (
        <li key={project._id}>
